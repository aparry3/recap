...
export const metadata: Metadata = {
  title: 'SMS Consent | Recap by Our Wedding Recap',
  description: 'How wedding guests optionally consent to Recap wedding gallery text messages.',
}
      ...
      <Column className={styles.content}>
        <Column className={styles.intro}>
          ...
          <Text as="h1" size={2.7} weight={700} className={styles.title}>
            How wedding guests opt in to Recap texts
          </Text>
          <Text as="p" size={1.1} className={styles.lede}>
            Recap by Our Wedding Recap sends optional, low-volume wedding updates only after a guest enters their own phone number and separately chooses SMS updates for a specific gallery.
          </Text>
        </Column>
        ...
        <Column className={styles.section}>
          ...
          <ol className={styles.steps}>
            <li>The couple shares a password-protected Recap gallery link with their guests.</li>
            ...
            <li>After submission, Recap records the consent and sends an enrollment confirmation.</li>
          </ol>
        </Column>
        ...
        <Column className={styles.demoSection}>
          ...
          <Text as="p" className={styles.note}>
            This page documents the consent experience for reviewers and guests; it does not collect a phone number or create an SMS subscription. Actual opt-in occurs inside a joined wedding gallery. Recap does not support initial opt-in by texting a keyword.
          </Text>
        </Column>
        ...
        <Column className={styles.section}>
          ...
          <dl className={styles.details}>
            <div><dt>Program and sender</dt><dd>Recap by Our Wedding Recap</dd></div>
            <div><dt>Operator</dt><dd>Parry Technology and Media, LLC, doing business as Our Wedding Recap</dd></div>
            <div><dt>Message frequency</dt><dd>Up to 10 business-initiated automated wedding updates per gallery, including the enrollment confirmation. Additional service responses may be sent only after a guest messages Recap.</dd></div>
