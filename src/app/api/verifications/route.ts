...
export const POST = async (req: Request) => {
    try {
        const {personId, galleryName, email, name, createGallery, theKnot, zola} = verificationRequestSchema.parse(await req.json())
