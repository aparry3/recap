...
<head>
    ...
    <title>Verify your email for ${galleryName}</title>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #FFFFFF; max-width: 600px; width: 100%;">
                    ...
                    <tr>
                        <td align="center" style="background-color: #EFD5D0; padding: 30px 20px;">
                            ...
                            <h1 style="color: #926C60; font-size: 28px; font-weight: 600; margin: 0; text-align: center;">Verify your email for ${galleryName}</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 20px;">
                            ...
                            <p style="margin: 0 0 25px; font-size: 16px;">Click to confirm your email address for the ${galleryName} gallery:</p>

                            <!-- CTA Button -->
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 0 0 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="${verificationUrl}" style="display: inline-block; padding: 14px 32px; background-color: #926C60; color: #FFFFFF; text-decoration: none; border-radius: 4px; font-weight: 600; font-size: 18px;">Verify Email</a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <ul style="margin: 0 0 30px; padding-left: 20px;">
                                <li style="margin-bottom: 10px; font-size: 16px;">Access the ${galleryName} gallery from your profile</li>
