...
<head>
    ...
    <title>You've been added as an admin to Our Wedding Recap!</title>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #FFFFFF; max-width: 600px; width: 100%;">
                    ...
                    <tr>
                        <td align="center" style="background-color: #EFD5D0; padding: 30px 20px;">
                            ...
                            <h1 style="color: #926C60; font-size: 28px; font-weight: 600; margin: 0; text-align: center;">You've been added as an admin to Our Wedding Recap!</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 20px;">
                            ...
                            <p style="margin: 0 0 25px; font-size: 16px;">You have been added as an admin to Our Wedding Recap! As an admin, you'll have access to powerful tools to manage galleries and users across the platform.</p>
